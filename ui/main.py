...
"""
    ...
    while run_server:
        ...
        try:
            ...
            ui.queue().launch(inline=True,share=True,inbrowser=True, server_name=server_name, server_port=server_port,  ssl_verify=ssl_verify, prevent_thread_lock=True, show_error=True)
