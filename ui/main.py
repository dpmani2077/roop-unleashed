...
"""
    ...
    while run_server:
        ...
        uii.ui_restart_server = False
        try:
            ui.queue().launch(share=True,inbrowser=True, server_name=server_name, server_port=server_port, share=roop.globals.CFG.server_share, ssl_verify=ssl_verify, prevent_thread_lock=True, show_error=True)
